<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center gap-3">
                ...
                <div class="hidden sm:flex items-center gap-2">
                    ...
                    <a href="{{ route('react.app') }}" class="px-3 py-2 rounded-lg {{ request()->routeIs('react.feed-page') || request()->routeIs('react.app') ? 'bg-indigo-700 text-white' : 'text-indigo-700 hover:bg-indigo-50' }}">React App</a>
                    @auth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t">
        <div class="pt-2 pb-3 space-y-1 px-4">
            ...
            <a class="block px-3 py-2 rounded-lg hover:bg-indigo-50 text-indigo-700" href="{{ route('react.app') }}">React App</a>
            @auth
                @if(auth()->user()->isAdmin())
