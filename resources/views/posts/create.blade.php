<x-app-layout>
  ...
  <div class="p-6">
    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data" class="space-y-4">
      ...
      <div>
        <label>Title</label>
        <input name="title" class="border rounded w-full" required>
      </div>

      <div>
        <label>Body</label>
        <textarea name="body" class="border rounded w-full" rows="6" required></textarea>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          <label>Price</label>
          <input name="price" type="number" step="0.01" class="border rounded w-full">
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <input name="location" class="border rounded w-full">
        </div>

        <div>
          <label>Condition</label>
          <input name="condition" class="border rounded w-full">
        </div>
      </div>
